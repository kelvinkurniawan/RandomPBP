...
<div class="row no-gutters">
    ...
    <div class="col pl-4 pr-4">
        ...
        <a href="<?php echo e(base_url('admin?openId='.$row->id)); ?>" class="card-as-link card widget center bg-randomize-3 mb-3 w-100 text-dark">
            <div class="card-body">
                <div class="post">
    ...
    <div class="col-md-3 bg-randomize-3 card widget right d-none d-sm-none d-md-block">
        <div class="container text-center sticky-top float-component h-100">
            <?php
                $ci =& get_instance(); 
