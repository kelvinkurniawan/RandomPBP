...
<div class="row no-gutters">
                    ...
                    <div class="friends mb-1">
                        <div class="row">
                            ...
                            <div class="col text-left">
                                ...
                                <div class="h4 font-weight-bold"><?php echo e($totalPost); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="friends mb-1">
                        <div class="row">
                            ...
                            <div class="col text-left">
                                ...
                                <div class="h4 font-weight-bold"><?php echo e($totalUser); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col pl-4 pr-4">
        ...
        <a href="<?php echo e(base_url('admin?openId='.$row->id)); ?>" class="card-as-link card widget center mb-3 bg-randomize-3 w-100 text-dark">
            <div class="card-body">
                <div class="post">
                        ...
                        <div class="row">
                            <div class="col-2 ">
                                <div class="photo-profile">
                                    <?php echo e(get_images(getUserById($row->id, "photo"))); ?>

                                </div>
                            </div>
                            <div class="col">
                                <div class="post-author"><?php echo e(getUserById($row->id, "name")); ?></div>
                                <div class="post-body limit-text d-none d-sm-block">
                                    <?php echo e(getUserById($row->id, "bio")); ?>
        ...
        <div class="d-sm-block d-md-none mb-3 card widget bg-randomize-3 text-center p-3"><a href="<?php echo e(base_url('admin/detail/'.$row->id)); ?>" class="text-primary">View Profile</a></div>
    ...
    <div class="col-md-3 bg-randomize-3 card widget right d-none d-sm-none d-md-block">
        <div class="container text-center sticky-top float-component">
            ...
            <?php else: ?>
            <div class="mt-3">
                <img class="rounded-circle" src="<?php echo e(get_images_path(getUserById($selectId, 'photo'))); ?>" width="50%">
            </div>
            <div class="font-weight-bold mt-3 text-dark"><?php echo e(getUserById($selectId, "name")); ?></div>
            <div class="mt-1 mb-3 text-dark d-flex justify-content-center align-items-center small">
                ...
                <div class="ml-1"><em><?php echo e(getUserById($selectId, "birth")); ?></em></div>
            </div>
            <div class="font-weight-light text-dark small mt-1">
                <?php echo e(getUserById($selectId, "bio")); ?>

            </div>
            <div><a href="<?php echo e(base_url('admin/detail/'.$selectId)); ?>" class="btn btn-randomize btn-ghost mt-5 w-50">View Profile</a></div>
            <div><a href="<?php echo e(base_url('admin/deleteUser/'.$selectId)); ?>" class="btn text-danger mt-3 w-50">Delete User</a></div>
            <?php endif; ?>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\random3\application\views/pages/admin.blade.php ENDPATH**/ ?>