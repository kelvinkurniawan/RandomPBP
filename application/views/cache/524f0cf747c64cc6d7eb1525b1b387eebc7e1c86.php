					...
					<div class="row">
						...
						<div class="col">
							<form action="<?= base_url('/home/performAddPost/home') ?>" method="POST">
								<?php if($single): ?>
								<input type="hidden" name="parent" class="input-parent" value="<?php echo e($parent); ?>">
								<?php else: ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kelb4779/public_html/random-v1/application/views/pages/home.blade.php ENDPATH**/ ?>