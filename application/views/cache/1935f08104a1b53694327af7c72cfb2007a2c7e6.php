...
<div class="row no-gutters">
    <div class="col-md-3 bg-randomize-2 card widget left d-sm-block d-md-none d-lg-none d-xl-none">
        <div class="container">
            <div class="row mt-3">
                ...
                <div class="col">
                    <div class="font-weight-bold text-light h4"><?php echo e(getUserById($userId, "name")); ?></div>
                    <div class="font-weight-light text-light small mt-1 limit-text">
                        <?php echo e(getUserById($userId,"bio")); ?>
            ...
            <div class="row mt-4">
                ...
                <div class="col">
                    <div><a class="btn btn-randomize btn-out w-100" href="<?php echo e(base_url('/authentication/logout')); ?>">Log Out</a></div>
                </div>
            </div>
            <?php endif; ?>
        </div>
    ...
    <div class="col-md-3 bg-randomize-2 card widget left d-none d-sm-none d-md-block">
        <div class="container text-center sticky-top float-component">
            <div class="mt-3">
                <img class="rounded-circle" src="<?php echo e(get_images_path(getUserById($userId, 'photo'))); ?>" width="50%">
            </div>
            <div class="font-weight-bold mt-3 text-light"><?php echo e(getUserById($userId, "name")); ?></div>
            <div class="mt-1 mb-3 text-white d-flex justify-content-center align-items-center small">
                ...
                <div class="ml-1"><em><?php echo e(getUserById($userId, "birth")); ?></em></div>
            </div>
            ...
            <?php if(getUserById($userId, "role") == 1): ?>
            <div>
                <a href="<?php echo e(base_url('/admin/')); ?>" class="btn btn-randomize btn-ghost mt-3 w-50">Admin Page</a>
            </div>
            <?php endif; ?>
    ...
    <div class="col-md-6 main-content w-100">
        <div class="card widget onProfile bg-randomize-light pt-4">
            ...
            <div class="mt-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                            ...
                                            <span>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left" style="z-index: 100;" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item text-danger" href="<?php echo e(base_url('home/deletePost/'.$row->id)); ?>">Delete</a>
                                                    </div>
                                                </div>
                                            </span>
                                        </div>
                                        <div class="post-body pb-3">
                                            ...
                                            <?php if($row->have_attachment == 1): ?>
                                            <?php
                                            $fileName = $row->files;
                                            $ext = explode(".",$fileName);
                                            ?>
                                            <?php if($ext[1] == "png" || $ext[1] == "jpg" || $ext[1] == "gif"): ?>
                                            <div class="post-attachment mt-3">
                                                <img src="<?php echo e(base_url('/uploads/'.$row->files)); ?>" width="80%" style="border-radius: 10px;" alt="">
                                            </div>
                                            <?php else: ?>
                                            <video width="80%" style="border-radius: 10px; margin-top: 1rem" controls>
                                                <source src="<?php echo e(base_url('/uploads/'.$row->files)); ?>" type="video/mp4">
                                        ...
                                        <div class="post-control">
                                            <div class="d-flex justify-content-between">
                                                <?php if(isPostLiked($row->id)): ?>
                                                <div class="d-flex justify-content-center align-items-center"><a href="javascript:void(0)" onclick="unlike_post(<?php echo e($row->id); ?>)"><i class="gg-heart text-success" style="margin-right: 10px;"></i></a><a class="d-none d-sm-none d-md-block ml-1" href="javascript:void(0)" onclick="getPostLikes(<?php echo e($row->id); ?>)"> <?php echo e(getLikesCount($row->id)); ?> Likes</a></div>
                                                <?php else: ?>
                                                <div class="d-flex justify-content-center align-items-center"><a href="javascript:void(0)" onclick="like_post(<?php echo e($row->id); ?>)"><i class="gg-heart" style="margin-right: 10px;"></i></a><a class="d-none d-sm-none d-md-block ml-1" href="javascript:void(0)" onclick="getPostLikes(<?php echo e($row->id); ?>)"> <?php echo e(getLikesCount($row->id)); ?> Likes</a></div>
                                                <?php endif; ?>
                                                <a href="<?php echo e(base_url('home/read/'.$row->id)); ?>"><i class="gg-comment" style="margin-right: 10px;"></i> <?php echo e(getRepliesCount($row->id)); ?><span class="ml-1 d-none d-sm-none d-md-block">Replies</span></a>
                                                <a href="javascript:void(0)" onclick="sharePost(<?php echo e($row->id); ?>)"><i class="gg-share" style="margin-right: 15px;"></i> <span class="ml-1 d-none d-sm-none d-md-block">Shares</span></a>
                                            </div>
                                        </div>
                ...
                <div class="share-container post-<?php echo e($row->id); ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pl-4 pr-4">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="bio" class="form-control"><?php echo e(getUserById($userId, 'bio')); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Fullname</label>
                        <input type="text" name="name" value="<?php echo e(getUserById($userId, 'name')); ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" name="email" value='<?php echo e(getUserById($userId, 'email')); ?>' class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Username</label>
                        <input type="text" name="username" value='<?php echo e(getUserById($userId, 'username')); ?>' class="form-control" aria-describedby="emailHelp">
                    </div>
                    <div class="form-group">
