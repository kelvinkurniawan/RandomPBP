...
<div class="row no-gutters">
    ...
    <div class="col pl-4 pr-4">
        ...
        <div class="bg-randomize-3 card widget center mb-3 w-100">
                ...
                <div class="post">
                    <div class="post-single">
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="post-author"><?php echo e(getPostAuthor($row->id)); ?></div>
                                <div class="post-body">
            ...
            <div class="bg-randomize-3 p-1 card widget center">
                <div class="row text-center">
                    <div class="col">
                        <div><a href="<?php echo e(base_url('admin/deletePost/'.$id.'/'.$row->id)); ?>" class="btn text-danger w-50">Delete Post</a></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-3  bg-randomize-3 card widget d-none d-sm-none d-md-block">
        <div class="container text-center sticky-top float-component">
            <div class="mt-3">
                <img class="rounded-circle" src="<?php echo e(get_images_path(getUserById($id, 'photo'))); ?>" width="50%">
            </div>
            <div class="font-weight-bold mt-3 text-dark"><?php echo e(getUserById($id, "name")); ?></div>
            <div class="mt-1 mb-3 text-dark d-flex justify-content-center align-items-center small">
                ...
                <div class="ml-1"><em><?php echo e(getUserById($id, "birth")); ?></em></div>
            </div>
            <div class="font-weight-light text-dark small mt-1">
                <?php echo e(getUserById($id, "bio")); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\random3\application\views/pages/admindetail.blade.php ENDPATH**/ ?>