	...
	<div class="row no-gutters w-100">
		...
		<div class="col-md-6 main-content w-100">
			<div class="card widget bg-randomize-3 center mt-4">
				<div class="card-body">
					<div class="row">
						<div class="col-2 pt-2 d-none d-sm-block"><?php echo e(get_images(getUserDetail('photo'))); ?></div>
						<div class="col">
							<form action="<?php echo e(base_url('/home/performAddPost/home')); ?>" method="POST">
						...
						<?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="friends">
								<div class="row align-items-center">
									<div class="col-md-4">
										<?php echo e(get_images($user->photo)); ?>
