        ...
        <div class="row col-md-10">
            ...
            <div class="col-md-6 bg-randomize-2 elevation py-4 d-flex">
                <div class="w-100 d-flex flex-column justify-content-center align-items-center px-2">
                    ...
                    <a href="<?php echo e(base_url('/session/new')); ?>" class="btn btn-randomize btn-ghost">Sign In</a>
                </div>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.authentication', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kelb4779/public_html/random-v1/application/views/sign-up.blade.php ENDPATH**/ ?>