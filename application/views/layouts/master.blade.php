...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{base_url('/static/jssocials/jssocials.css')}}" />
    <link type="text/css" rel="stylesheet" href="{{base_url('/static/jssocials/jssocials-theme-minima.css')}}" />
...
<body class="bg-randomize-light">
    ...
    <script src="{{base_url('/static/jssocials/jssocials.min.js')}}"></script>
